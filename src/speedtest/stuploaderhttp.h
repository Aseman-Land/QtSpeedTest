...
#ifndef STUPLOADERHTTP_H
#define STUPLOADERHTTP_H
...
class LIBQSPEEDTESTSHARED_EXPORT STUploaderHttp : public QObject
{
    Q_OBJECT
    Q_ENUMS(Status)
...
public:
    ...
    STUploaderHttp(STClient *client, QObject *parent = Q_NULLPTR);
    virtual ~STUploaderHttp();
...
Q_DECLARE_METATYPE(STUploaderHttp::Status)

#endif // STUPLOADERHTTP_H
